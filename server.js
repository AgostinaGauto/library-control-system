...
// Ejecuta el archivo de conexión a la base de datos (que inicializa Sequelize)
// para establecer la conexión al inicio de la aplicación.
require('./database/connection'); // Conexión a la DB
